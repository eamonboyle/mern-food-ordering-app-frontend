...
const HomePage = () => {
    ...
    return (
        <div className="flex flex-col gap-12">
            <div className="bg-white rounded-lg shadow-md py-8 flex flex-col gap-5 text-center -mt-16 px-5 md:px-32">
                <h1 className="text-5xl font-bold tracking-tight text-orange-600">Tuck into a takeaway today</h1>
                <span className="text-xl text-gray-800">Food is just a click away</span>
                <SearchBar placeholder="Search for restaurants" onSubmit={handleSearchSubmit} />
            </div>
